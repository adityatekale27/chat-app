...
export function DialogBox({ isOpen, onClose, trigger, dialogTitle = "", dialogDescription = "", children }: DialogBoxProps) {
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      <DialogContent className="max-h-[85%] overflow-y-auto fixed left-1/2 top-1/2 w-full -translate-x-1/2 -translate-y-1/2 rounded-lg bg-white dark:bg-[#212121] p-3 md:p-5 shadow-lg transition-all">
